...
public class RCHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        ...
        int roundCornerTopLeft = ta
                .getDimensionPixelSize(R.styleable.RCAttrs_round_corner_top_left, roundCorner);
        int roundCornerTopRight = ta
                .getDimensionPixelSize(R.styleable.RCAttrs_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta
                .getDimensionPixelSize(R.styleable.RCAttrs_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta
                .getDimensionPixelSize(R.styleable.RCAttrs_round_corner_bottom_right, roundCorner);
        ta.recycle();
    ...
    public void drawableStateChanged(View view) {
        if (view instanceof RCAttrs) {
            ...
            if (mStrokeColorStateList != null && mStrokeColorStateList.isStateful()) {
                ...
                int stateColor = mStrokeColorStateList
                        .getColorForState(stateList, mDefaultStrokeColor);
